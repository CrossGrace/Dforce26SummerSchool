...
const C = {
  id:'C', short:'카드 순서 맞추기', title:'마음으로 전하는 이야기', verse:'로마서 10:10', icon:'▱', accent:'#9d7bff',
  ...
  missions:make(['경청의 고백','비밀 수호 선서','동행 하이파이브','소통의 칭찬','믿음의 구호','팀원 한마음 퀴즈','하나님 나라 선포','사랑의 안아주기','감사 기도 멘트','비전 탐험대 구호'],[
    '“지체의 목소리에 귀 기울이겠습니다!” 외치기','“내 카드를 절대 보여주지 않겠습니다!” 다짐하기','양옆 팀원과 손을 맞잡고 “함께하자!” 말하기','카드를 설명한 지체에게 “설명 최고야!” 칭찬','“하나님의 선하신 계획은 반드시 이루어집니다!” 선포','“우리 조장님의 성함은?” 맞추고 환호하기','“우리는 하나님 나라의 특별한 주인공!” 외치기','옆 지체를 안아주며 “네 말이 잘 보여!” 말하기','“하나님, 우리 조를 모아주셔서 감사합니다!” 외치기','“디포스 비전 탐험대, 미션 클리어 가자!” 외치기']),
